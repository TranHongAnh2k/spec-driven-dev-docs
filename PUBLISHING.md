...
Trình duyệt sẽ mở trang xác thực npm. Đăng nhập bằng account `anhth2`, sau đó quay lại terminal.
...
### 2. Tạo Access Token (nếu cần dùng CI hoặc tránh 2FA mỗi lần)
...
## Transfer package sang account khác

Khi cần chuyển quyền sở hữu package cho người khác (ví dụ: chuyển sang account `edupia-team`):
